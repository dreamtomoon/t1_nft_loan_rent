...
library TribeOneHelper {
    ...
    function safeTransfer(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "TribeOneHelper::safeTransfer: transfer failed"
        );
    }
    ...
    function safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "TribeOneHelper::transferFrom: transferFrom failed"
        );
    }
    ...
    function permit(
        ...
        require(recoveredAddress != address(0) && recoveredAddress == _sender, "TribeOne: INVALID_SIGNATURE");
    }
}
